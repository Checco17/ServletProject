...
<title>INSERIMENTO AUTOMOBILE</title>
</head>

<body>
<h1>AGGIUNGI UN AUTOMOBILE NEL DATABASE</h1>
<fieldset>
	<form action="AutoServlet?op=add" method="POST">
		<label>TARGA:</label> <input name="targa" id="targa" value=""
			type="text"> <br> <br> <label>PROPRIETARIO:</label>
		<input name="proprietario" id="proprietario" value="" type="text"><br> <br>

		<input type="submit" value="Salva modifica" /> <br> <br> <a href="welcome.jsp">TORNA
			A BENVENUTO</a>
